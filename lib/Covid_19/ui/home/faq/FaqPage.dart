...
import 'package:miniProject/Covid_19/ui/webview/WebViewDetails.dart';
        ...
        children: <Widget>[
          InkWell(
            ...
            child: getSingleFaqView(
                ...
                'assets/img//faq_howitspreads.png'),
          ),
          InkWell(
            onTap: () {
              var webViewDetails =
          ...
          InkWell(
            ...
            child: getSingleFaqView(
                'How to use Mask?',
                'When & How to use Mask.',
                'assets/img//faq_protectyourself.png'),
          ),
          InkWell(
            onTap: () {
              var webViewDetails = WebViewDetails(
            ...
            child: getSingleFaqView(
                'Media resources',
                'Visit to get the resources',
                'assets/img//faq_mediaresources.png'),
          ),
          InkWell(
            onTap: () {
              var webViewDetails = WebViewDetails(
            ...
            child: getSingleFaqView('Advice for public',
                'WHO advice for public', 'assets/img//faq_mythbusters.png'),
          ),
        ],
      ),
    );
